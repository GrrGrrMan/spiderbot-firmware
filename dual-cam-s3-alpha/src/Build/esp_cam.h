...
// ─────────────────────────────────────────────────────────────────────────────
// esp_cam.h — self-contained target configuration.
...
// ESP32-CAM target profile. Keep legacy topics here so old controllers still
// work while this board has its own full configuration.
#define CFG_TARGET_NAME "esp_cam"
#define CFG_DEFAULT_MQTT_CLIENT "esp32-spiderbot"
#define CFG_DEFAULT_MQTT_NAMESPACE "alphaesp32"
#define CFG_DEFAULT_MQTT_DEVICE_ID "spiderbot01"
#define CFG_DEFAULT_MQTT_TOPIC_OTA "beanspiderbot/ota/TG398Z"
#define CFG_DEFAULT_MQTT_TOPIC_CMD "beanspiderbot/cmd"
#define CFG_DEFAULT_MQTT_TOPIC_LOG "beanspiderbot/log"
#define CFG_DEFAULT_OTA_BRANCH "main"
#define CFG_DEFAULT_OTA_FALLBACK_BRANCH "main"
#define CFG_DEFAULT_OTA_ARTIFACT_BASENAME "bin/firmware-esp32cam"
#define CFG_DEFAULT_ONBOARD_RGB_PIN -1
#define CFG_DEFAULT_ONBOARD_RGB_DISABLE 0

#if __has_include("local_config.esp_cam.h")
#include "local_config.esp_cam.h"
#endif
...
#define CFG_ULTRASOUND_TRIG_PIN 14
#define CFG_ULTRASOUND_ECHO_PIN 13
#define CFG_ULTRASOUND_LED_PIN 0
