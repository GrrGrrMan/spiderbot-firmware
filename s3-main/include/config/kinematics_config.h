...
#define COXA_MIN_DEG   -40.0f
#define COXA_MAX_DEG    40.0f

#define FEMUR_MIN_DEG  -90.0f
#define FEMUR_MAX_DEG   50.0f

#define TIBIA_MIN_DEG  -65.0f
#define TIBIA_MAX_DEG   70.0f
...
#define DEFAULT_FOOT_X   118.0f 
#define DEFAULT_FOOT_Y     0.0f  
#define DEFAULT_FOOT_Z  -132.0f  